...
const wchar_t* windowName = L"TRIANGLE";
...
VkResult createShaders()
{
	...
	vkShaderModuleVertex = loadSPIRVShader("Shader.vert.spv");
	...
	vkShaderModuleVertex = loadSPIRVShader("Shader.frag.spv");
	if (vkShaderModuleVertex == VK_NULL_HANDLE)
	{
