...
#pragma region RECORD COMMAND BUFFER
		...
		//here we should call vulkan drawing functions
		{
			...
			vkCmdDraw(vkCommandBuffersVector[i], 4, 1, 0, 0);
		}
...
VkResult createVertexBuffer()
{
	...
	//VERTEX POSITION
	vkResult = createAttributeData(vertexPositionBufferTriangle, vertexDataPosition);
	if (vkResult != VK_SUCCESS)
	{
	...
	//VERTEX COLOR
	vkResult = createAttributeData(vertexColorBuffer, vertexDataColor);
	if (vkResult != VK_SUCCESS)
	{
...
VkResult createGraphicsPipeline()
{
	...
	vkPipelineInputAssemblyStateCreateInfo.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN;	//Not recommended, 
