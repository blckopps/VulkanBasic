...
VkResult UpdateUniformBuffer()
{
	...
	{
		orthographicProjectionMatrix = glm::ortho(-100.0f, 100.0f, -100.0f * (float)winHeight/winWidth, 
			100.0f * (float)winHeight / winWidth, -100.0f, 100.0f);
	}
	else
	{
		orthographicProjectionMatrix = glm::ortho(-100.0f * (float)winWidth / winHeight, 100.0f * (float)winWidth / winHeight, -100.0f ,
