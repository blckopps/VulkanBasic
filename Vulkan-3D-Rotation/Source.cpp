...
const char* gpSzAppName = "VK-3D-ROTATION";
const wchar_t* windowName = L"3D-ROTATION";
...
//Create image and image views for color images and depth image
VkResult createImageAndImageViews()
{
...
VkResult createRenderPass()
{
	...
	vkAttachmentReferenceColor.attachment = 0;
	vkAttachmentReferenceColor.layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
	...
	//Count is attachment reference and not description
	vkSubpassDescription.colorAttachmentCount = 1;
	vkSubpassDescription.pColorAttachments = &vkAttachmentReferenceColor;
...
VkResult UpdateUniformBuffer()
{
	...
	translationMatrix = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, 0.0f, -5.0f));
